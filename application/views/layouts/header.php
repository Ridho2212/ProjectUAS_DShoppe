...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/images/logo_edit.png') ?>" type="image/gif">
    <title>D'Shoppe</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php echo base_url('assets/images/logo1.png') ?>" alt="DShoppeLogo" height="60">
        </div>
